...
const UpdatePostModal = () => {
  ...
  }, [setShowUpdatePostModal, setUpdatedPost, post])
  ...
  const onFinish = useCallback(async values => {
    ...
    setShowUpdatePostModal(false)
    openNotification()
  }, [updatePost, setShowUpdatePostModal, openNotification, updatedPost])

  return (
    <>
      <Modal title="What's up mann?" visible={showUpdatePostModal} onCancel={closeModal}
        footer={null}>
